...
class _DreamListViewState extends State<DreamListView>
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: 2,
      vsync: this,
      initialIndex: widget.folderId != null ? 0 : 0, // Varsayılan olarak rüyalar tab'ı
    );
    _loadUserProfile();
  }
  ...
  Widget _buildDreamsList(BuildContext context, ThemeData theme, AppLocalizations l10n) {
