  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => sl<SavedHoroscopeCubit>()..loadSavedHoroscopes()),
...
class _HoroscopeViewState extends State<HoroscopeView>
  ...
  Widget _buildNewHoroscopeTab(BuildContext context, AppLocalizations l10n, ThemeData theme) {
    final signKeys = [
      'aries',
      'taurus',
      'gemini',
  ...
  Widget _buildSavedHoroscopesTab(BuildContext context, ThemeData theme) {
    return Column(
      children: [
        ...
        BlocBuilder<FolderListBloc, FolderListState>(
          builder: (context, folderState) {
            if (folderState is FolderListLoaded && folderState.folders.isNotEmpty) {
              return Container(
                padding: const EdgeInsets.all(12),
                child: Row(
                  children: [
